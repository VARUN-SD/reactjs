...
const RestaurantCard=(props)=>{
    ...
    return(
        <div className='res-card' style={{backgroundColor:"lightgray"}}>
            <img className='res-image' alt="Food Image" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId}/>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>
            <h4>{costForTwo}</h4>
...
const resList=[
    {
      ...
      "analytics": {
        "context": "seo-data-581698e4-fa0a-49ca-a090-ea37754dd03a"
      },
      "cta": {
        "link": "https://www.swiggy.com/restaurants/new-city-dhaba-family-restaurant-naimnagar-hanamkonda-warangal-400100",
    ...
    },
    {
      "info": {
        "id": "154678",
        "name": "New Model Restaurant",
        "cloudinaryImageId": "bubofpcmgkf6ohorjvya",
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/new-model-restaurant-enugulagadda-hanamkonda-warangal-154678",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
    },
    {
      "info": {
        "id": "75393",
        "name": "Green Bawarchi Restuarant",
        "cloudinaryImageId": "gzy7e1gjcfitrikcm3tl",
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/green-bawarchi-restuarant-vasavi-colony-warangal-warangal-75393",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
    ...
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/president-dhaba-jagruti-colony-hanamkonda-warangal-371313",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
